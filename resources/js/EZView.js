...
$.fn.EZView =  function(collectionName) {
        ...
        if (!$('#EZView' + collectionName).length) {
            ...
            var tools = 
                '<div class="tools-container">' +
                    ...
                    '<spam class="tools">' +
                        '<a class="download EZViewHighlight" download="" target="_blank">' +
                        '<img src="' + self.icons.download + '" title="Download"/></a>' +
                        '<a class="zoomIn EZViewHighlight" href="">' +
                        '<img src="' + self.icons.zoomIn + '" title="Zoom in" /></a>' +
                        '<a class="zoomOut EZViewHighlight" href="">' +
                        '<img src="' + self.icons.zoomOut + '" title="Zoom out" /></a>' +
                    '</spam>' +
                ...
                container = '<div class="image-collection"/>' +
                        '<a class="back EZViewHighlight"><img src="' + self.icons.back + '" title="Back" /></a>' +
                        '<a class="next EZViewHighlight"><img src="' + self.icons.next + '" title="Next" /></a>' +
                        tools,
    ...
    self.setContentOnViewer = function(htmlContent) {
        ...
        $('[index-content=' + collectionName + newIndex + ']').on( "error",function() {
            ...
            $(this).replaceWith('<h1 class = "content" index-content="' + collectionName + self.index[collectionName] + '" style="' + style + '">Unsupported Preview(Download Only)</h1>');
        ...
        self.$EZView
            ...
            .find('.EZViewHighlight>img').hover(
                function() {
                    $(this).css({
                        'border-radius':    '20px',
                        'background-color': 'rgba(81,203,206,0.7)',
                        'z-index':          '100000'
                    });
                },
                function() {
