          ...
          <li>
            <div class="row">
              ...
              <div class="col-md-3 col-3 text-right">
                ...
                @else
                <a href="{{route('admin-message', ['id' => $message->pr_id, 'name' => $message->name])}}" id="{{$message->pr_id}}" role="button" class="btn btn-sm btn-outline-danger btn-round btn-icon msgStatus"><i class="fa fa-envelope-open"></i></a>
                @endif
              </div>
            </div>
          </li>
